<template>
  <section class="w-full md:pt-7 md:pb-7 mx-auto md:pt-20 md:pb-24">
    <div class="box-border flex flex-col justify-center items-center content-center px-8 mx-auto leading-6 md:flex-row md:mt-10 max-w-7xl xl:px-16">
        ...
        <!-- Image -->
        <div class="box-border relative w-full max-w-md px-4 mt-0 mb-4 -ml-5 text-center md:ml-0 md:mt-0 md:max-w-none lg:mb-0 md:w-1/2 xl:-ml-10">
            <img src="~/static/images/benefit/Online lesson _Monochromatic.svg" class="p-2 pl-6 pr-5 xl:pl-16 xl:pr-20 " style="height: 100%;"/>
        </div>

        <!-- Content -->
        <div class="box-border order-first w-full text-blues border-solid md:w-1/2 md:order-none xl:-ml-10">
    ...
    <div class="box-border flex flex-col justify-center items-center content-center px-8 mx-auto mt-2 leading-6 md:mt-20 md:flex-row max-w-7xl xl:px-16">

        <!-- Content -->
        <div class="box-border w-full text-blues border-solid md:w-1/2 md:pl-6 xl:pl-32">
            <h2 class="m-0 text-xl font-semibold leading-tight border-0 border-gray-300 lg:text-3xl md:text-2xl">
        ...
        <!-- Image -->
        <div class="box-border relative w-full max-w-md px-4 xl:mt-10 mb-4 text-center md:mt-0 md:max-w-none md:mb-0 md:w-1/2">
            <img src="~/static/images/benefit/Career _Monochromatic(4).svg" class="pl-4 sm:pr-10 xl:pl-10" style="height: 100%;"/>
        </div>
    </div>
</section>
</template>
