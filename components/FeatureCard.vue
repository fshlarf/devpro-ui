<template>
  <div class="w-full flex justify-center items-center mx-auto card-feature xl:max-w-sm md:max-w-xxl lg: text-white text-center p-2 md:p-5 m-2 md:flex md:text-left xl:text-center xl:block">
    <div class="max-w-md">
